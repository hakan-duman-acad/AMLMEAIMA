...
full <- yas %>% select("IK", "IA","IMO", "AMA", "SIMO", 
                       "STSS", "GYYKGHO", "MD")
...
print(paste0("Hopkins p değeri ", 
             hopkins.pval(x = hp, nrow(clustBaked)/10))) #p değeri
...
clust <- eclust(x = clustBaked, FUNcluster = "kmeans",k = 2, 
